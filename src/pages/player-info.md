...
If you’d like to see an example, previous episodes can be viewed at [devopspartygames.com/videos](https://devopspartygames.com/videos).
...
The game will be streamed to [our Twitch channel](https://www.twitch.tv/devopspartygames/), which is how the audience watches and participates (more on that later). The Twitch channel displays the main screen of the game, plus the cameras of all players and hosts. All audio from the game (plus the Zoom call) is also streamed to Twitch, and audience interaction is encouraged!
...
19:50: Stream on [twitch.tv/devopspartygames](https://twitch.tv/devopspartygames) starts with “countdown to show” timer<br />
